...
public class attempt extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        popGrid=new popGridAdapter(attempt.this);
    ...
    void showPopUp(){
        AlertDialog.Builder builder=new AlertDialog.Builder(attempt.this);
...
//            String name=mDatabase.child(((Test) getIntent().getExtras().get("Questions")).getName()).toString();
    ...
    void dialogStart() {
        ...
        try{
            final AlertDialog.Builder builderSingle = new AlertDialog.Builder(attempt.this);
            builderSingle.setIcon(R.mipmap.ic_launcher);
            builderSingle.setTitle(TESTNAME+" Answers");
            final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>
                    (attempt.this, android.R.layout.select_dialog_singlechoice);
            ...
            builderSingle.setAdapter(arrayAdapter1, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    AlertDialog.Builder builderInner = new AlertDialog.Builder(attempt.this);
...
//                        dialog.dismiss();
    ...
    protected void onPause() {
        ...
        if(countPaused<=2 && countPaused >=0 && flag_controller == 1)
            startService(new Intent(attempt.this,
    ...
    protected void onResume() {
        super.onResume();
        stopService(new Intent(attempt.this, NotificationService.class));
        if(countPaused>2) {
            Toasty.success(attempt.this,"Thank you! Your response has been submitted.",
