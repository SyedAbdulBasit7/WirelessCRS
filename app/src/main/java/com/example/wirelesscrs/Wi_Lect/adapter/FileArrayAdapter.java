...
import static com.example.wirelesscrs.Wi_Lect.consts.PreferenceEntity.SHOW_MENU_BUTTON_INSTEAD_OF_CHECKBOX;
import static com.example.wirelesscrs.Wi_Lect.consts.PreferenceEntity.ZIPS_EXPLORABLE;
...
public class FileArrayAdapter extends BaseArrayAdapter {
    ...
    protected View initUI(FMFile f) {
        ...
        @SuppressLint("InflateParams") View v = LayoutInflater.from(activity).inflate(R.layout.lect_layout_file, null); // works.

        if (f != null) {
            TextView fileNameView = v.findViewById(R.id.lect_fileTitle);
            TextView filePermissions = v.findViewById(R.id.lect_filePermissions);
            TextView fileDate = v.findViewById(R.id.lect_fileDate);
            TextView fileSize = v.findViewById(R.id.lect_fileSize);
            ...
            CheckBox checkBox = v.findViewById(R.id.lect_fileCheckBox);
