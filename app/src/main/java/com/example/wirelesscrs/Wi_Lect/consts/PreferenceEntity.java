...
import com.example.wirelesscrs.Wi_Lect.Lecture;
import com.example.wirelesscrs.R;

import static com.example.wirelesscrs.Wi_Lect.consts.PreferenceStore.CLOUD_BACKED;
import static com.example.wirelesscrs.Wi_Lect.consts.PreferenceStore.LOCAL;
...
public enum PreferenceEntity {
     ...
     */
    SORT_FILES_BY(LOCAL, "sort_files_by", (Lecture.getContext() != null) ? Lecture.getContext().getString(R.string.pref_sortby_value_default) : "namea"),
...
//     * Always show
     ...
     */
    HEADER_PATH_LENGTH(CLOUD_BACKED, "header_path_length", (Lecture.getContext() != null) ? Lecture.getContext().getString(R.string.pref_header_path_length_default) : "27"),
