package com.example.wirelesscrs.reminder;
...
public class wics_reminder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wics_reminder);
        ...
        mAddReminderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), wics_add_reminder.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent=new Intent(wics_reminder.this,com.example.wirelesscrs.dashboard_wics.class);
        startActivity(intent);
        return;
    }
    ...
    private void selectReminder(int mClickID) {
        ...
        Intent i = new Intent(this, wics_edit_reminder.class);
        i.putExtra(wics_edit_reminder.EXTRA_REMINDER_ID, mStringClickID);
...
//    }
    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        ...
        public VerticalItemHolder onCreateViewHolder(ViewGroup container, int viewType) {
            ...
            View root = inflater.inflate(R.layout.reminder_recycle_item, container, false);
        ...
        public  class VerticalItemHolder extends SwappingHolder
            ...
            public boolean onLongClick(View v) {
                AppCompatActivity activity = wics_reminder.this;
