                            ...
                            .setPositiveButton("OK",
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog,int id) {
                                            ...
                                            // edit text
                                            String save_n=userInput.getText().toString().trim();
                                            if (str != null ) {
                                                if(un!=null){
                                                    Toasty.warning(getApplicationContext()
                                                        ,"Please enter name '"+save_n+"' again", Toasty.LENGTH_LONG).show();
...
//                                         result.setText(userInput.getText());
                                                if(un==null){
                                                    Toasty.success(getApplicationContext()
                                                            ,"Save Successfully", Toasty.LENGTH_LONG).show();
                                                Map<String, Object> result = new Gson().fromJson(jsonStr, Map.class);
                                                fileName = userInput.getText().toString().trim();
                                                if (!TextUtils.isEmpty(fileName))
                                                    myRef.child("tests").child(fileName).setValue(result);
                                                Intent intent=new Intent(Custom_quiz.this, MainActivity.class);
