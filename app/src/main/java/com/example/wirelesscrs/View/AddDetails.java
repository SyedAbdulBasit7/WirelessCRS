...
import com.example.wirelesscrs.Misc_Section.ImageUtils;
...
public class AddDetails extends AppCompatActivity {
    ...
    private Spinner section,sem,course;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        course=findViewById(R.id.Branch_spinner);
        ...
        course.setAdapter(BranchAdapter);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                User user=new User(name.getText().toString(),sem.getSelectedItem().toString(),
                        course.getSelectedItem().toString(),section.getSelectedItem().toString());
                if(name!=null) {
                    //
        ...
        mDatabase.child("users").child(Objects.requireNonNull(auth.getUid())).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if(name.getText().toString().equals("")&&dataSnapshot.exists()){
                            ...
                            course.setSelection(Arrays.asList(AddDetails.this.getResources()
                                    .getStringArray(R.array.Branch_Choice)).indexOf(user.course));
