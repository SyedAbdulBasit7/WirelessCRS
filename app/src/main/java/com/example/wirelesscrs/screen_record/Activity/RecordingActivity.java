...
public class RecordingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        address = findViewById(R.id.srv_address);
        audioSwitch = findViewById(R.id.srv_sAudio);
        audio = findViewById(R.id.srv_Audio);
        folder = findViewById(R.id.srv_folder);
        count = findViewById(R.id.srv_count);
        desc3 = findViewById(R.id.srv_desc3);
        desc1 = findViewById(R.id.srv_desc1);
    ...
    private void countDialog() {
        ...
        timertxt = dialog.findViewById(R.id.srv_timertxt);
        seekBar = dialog.findViewById(R.id.srv_seekBar);
