...
import com.example.wirelesscrs.screen_record.Activity.SettingsActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.srv_toolbar);
        ...
        fab = (FloatingActionButton) findViewById(R.id.srv_fav);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (sharedPref.loadView() == 1) {
            menu.findItem(R.id.srv_Change).setIcon(AnimatedVectorDrawableCompat.create(com.example.wirelesscrs.screen_record.Recorder.MainActivity.this, R.drawable.avd_grid_to_list));
        } else {
            menu.findItem(R.id.srv_Change).setIcon(AnimatedVectorDrawableCompat.create(com.example.wirelesscrs.screen_record.Recorder.MainActivity.this, R.drawable.avd_list_to_grid));
        }
