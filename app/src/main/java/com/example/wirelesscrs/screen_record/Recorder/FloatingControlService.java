...
import com.example.wirelesscrs.screen_record.Recorder.Const.RecordingState;
...
public class FloatingControlService extends Service implements View.OnClickListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        controls = floatingControls.findViewById(R.id.srv_controls);

        //Initialize imageButtons
        ImageButton stopIB = (ImageButton) controls.findViewById(R.id.srv_stop);
        pauseIB = (ImageButton) controls.findViewById(R.id.srv_pause);
        resumeIB = (ImageButton) controls.findViewById(R.id.srv_resume);
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            controls.findViewById(R.id.srv_divider1).setVisibility(View.GONE);
            controls.findViewById(R.id.srv_divider2).setVisibility(View.GONE);
        } else {
