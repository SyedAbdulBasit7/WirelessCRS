...
import com.example.wirelesscrs.screen_record.Screen.ScreenReceiver;
...
import com.example.wirelesscrs.screen_record.Adapter.CustomAdapter;
import com.example.wirelesscrs.screen_record.Dialog.CountDown;
import com.example.wirelesscrs.screen_record.Interface.RecyclerClickListener;
import com.example.wirelesscrs.screen_record.Utils.RecyclerView.RecyclerTouchListener;
import com.example.wirelesscrs.screen_record.Utils.ToolbarActionModeCallback;
import com.example.wirelesscrs.screen_record.Utils.RecyclerView.EmptyRecyclerView;
import com.example.wirelesscrs.screen_record.Model.Item;
...
import static com.example.wirelesscrs.screen_record.Adapter.CustomAdapter.SPAN_COUNT_ONE;
import static com.example.wirelesscrs.screen_record.Adapter.CustomAdapter.SPAN_COUNT_TWO;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.srv_toolbar);
        toolbar.setTitle("");
        setSupportActionBar(toolbar);

        recyclerView = findViewById(R.id.srv_listView2);
        emptyView = findViewById(R.id.srv_emptyView);
        ...
        timL1 = findViewById(R.id.srv_timL1);
        timer = (TextView) findViewById(R.id.srv_timer);
        ...
        fav = (FloatingActionButton) findViewById(R.id.srv_fav);
        string1 = "s";
...
//        });
    ...
    public void activityStart() {
        ...
        notify1.start();
        Intent startMain = new Intent(MainActivity.this,dashboard_wics.class);
...
//        startMain.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (sharedPref.loadView() == 1) {
            menu.findItem(R.id.srv_Change).setIcon(AnimatedVectorDrawableCompat.create(MainActivity.this, R.drawable.avd_grid_to_list));
        } else {
            menu.findItem(R.id.srv_Change).setIcon(AnimatedVectorDrawableCompat.create(MainActivity.this, R.drawable.avd_list_to_grid));
        }
        if (adapter1.getItemCount() == 0) {
            menu.findItem(R.id.srv_Change).setVisible(false);
        } else {
            menu.findItem(R.id.srv_Change).setVisible(true);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.srv_share) {
            try {
...
//        mSensorManager.unregisterListener(mShakeDetector);
    ...
    private void onListItemSelect(int position) {
        ...
        if (mActionMode != null) {
            ...
            TextView actionTitle = findViewById(R.id.srv_actiontitle);
...
//                Toast.makeText(this, selected.size() + " item deleted.", Toast.LENGTH_SHORT).show();//Show Toast
    ...
    public void onBackPressed(){
        ...
        Intent intent=new Intent(MainActivity.this, dashboard_wics.class);
