...
public class QualityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        desc1 = findViewById(R.id.srv_des1);
        frate = findViewById(R.id.srv_fRate);
        bitRate = findViewById(R.id.srv_bitRate);
        desc2 = findViewById(R.id.srv_desc2);
    ...
    private void frateDialog() {
        ...
        final RadioGroup radioGroup = (RadioGroup) dialog.findViewById(R.id.srv_rg);
